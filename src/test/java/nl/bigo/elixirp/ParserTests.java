...
public class ParserTests extends BaseTest {
    ...
    private final ElixirLexer lexer;
    private final ElixirParser parser;

    public ParserTests() {
        this.lexer = new ElixirLexer(CharStreams.fromString(""));
        this.parser = new ElixirParser(new CommonTokenStream(lexer));
    ...
    public void testAllFiles() throws Exception {
        var files = new File("./elixir").listFiles((dir, name) -> name.endsWith(".ex"));
    ...
    public void testBlock() throws Exception {
        testFile(new File("./elixir/block.ex"));
    }
